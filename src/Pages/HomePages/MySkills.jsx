...
import { SiArduino, SiExpress, SiFigma, SiVercel, SiNextdotjs } from 'react-icons/si';
...
const MySkills = () => {
  ...
  return (
    <div>
      <div className='my-8'>
        <button className='flex items-center gap-4 py-2 px-4 border-b-2 font-bold md:text-lg rounded-2xl border-emerald-800 text-white btn-outline uppercase'><LiaShapesSolid className='text-2xl' />Skills</button>
      </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-10 ">
          {skills.map((skill, index) => (
            ...
            >
              ...
              <div className="w-[90%] bg-gray-200 rounded-full border h-5 dark:bg-gray-700 mt-4">
                <div className={`bg-blue-700 h-5 rounded-full text-sm text-center text-white font-semibold`} style={{ width: `${skill.progress}%` }}>{skill.progress}%</div>
              </div>
            </div>
          ))}
        </div>
