    ...
    return (
        <div>
            ...
            <div className='py-12 uppercase space-y-8'>
                <p className='text-center text-[49px] font-bold'>Hello! This is <span className='text-violet-800'>Hasan Masud</span></p>
                <p className='text-center text-[29px] font-bold'>A Full-Stack Developer (MERN)</p>
            </div>
        </div>
    );
};
