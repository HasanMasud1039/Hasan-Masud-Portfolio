...
const Introduction = () => {
    return (
        <div>
            <div className='mt-8'>
                <button className='btn btn-md font-bold md:text-lg rounded-2xl border-emerald-800 hover:bg-violet-800 hover:text-white btn-outline'><FaHome/> Introduction</button>
            </div>
